...
# Shamelessly stolen from https://github.com/killer-sh/cks-course-environment
...
# Install kube-bench
mkdir kube-bench
cd kube-bench && curl -L https://github.com/aquasecurity/kube-bench/releases/download/v0.6.2/kube-bench_0.6.2_linux_amd64.tar.gz -o kube-bench_0.6.2_linux_amd64.tar.gz
